...
- **Closest analog**, when one exists, with the one-line mechanism rather than just the name. The example that lands is the one where you can see exactly what the move was
