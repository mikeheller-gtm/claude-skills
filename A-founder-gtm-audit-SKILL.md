---
name: founder-gtm-audit
description: "Get seed-stage sales coaching and a go-to-market audit on your own sales calls, in the advisory voice of Mike Heller (Floodgate). Use this skill whenever the user shares sales call transcripts (pasted text, or Granola/Gong/Chorus links or exports) and wants feedback, or mentions 'call review', 'GTM audit', 'sales audit', 'review my call', 'how did this call go', 'why aren't my deals closing', or asks for feedback on a discovery call, demo, pricing conversation, follow-up email, or outbound sequence. Also use it when the user wants a full review of their sales motion across multiple calls. Trigger even for casual requests like 'quick feedback on this call' -- the skill scales from single-call tactical feedback to a full multi-call GTM audit."
---

# GTM Audit: Sales Motion Review for Seed-Stage Founders
